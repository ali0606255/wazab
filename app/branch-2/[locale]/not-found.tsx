...
/**
 * Rendered for unknown paths under a branch-2 locale. `notFound()` unwinds past the
 * dynamic segment, so this file cannot read `params` — it speaks the default locale.
 */
export default function Branch2NotFound() {
